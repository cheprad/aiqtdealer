<?php 
    ...
    if(isset($_POST['edit_user'])){
        ...
        $sql = "UPDATE `aiqtdealer`.`user` SET `firstname` = '$firstname', `lastname` = '$lastname' ,`email` = '$email' , `telnum` = '$telnum' ,`userrole`= '$userrole' WHERE `user`.`userid` = 19";
        $query = mysql_query($sql,$conn);

        // header("location: shop_edit_success.php");
    }
?>
<!DOCTYPE html>
<html lang="en"> 
		    ...
		    <div class="container-xl">			    
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">บันทึกสำเร็จแล้ว กดปุ่ม home เพื่อกลับหน้า admin</div>
	                </div>
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="index.php">
								    ...
								    <div class="mb-3">
										...
										<?php 
											echo '<input name="firstname" type="text" class="form-control" id="setting-input-1" value="'.$firstname.'"readonly>';
										?>
									...
									<div class="mb-3 ">
									    ...
									    <?php 
											echo '<input name="lastname" type="text" class="form-control" id="setting-input-1" value="'.$lastname.'" readonly>'
										?>
									</div>
									<div class="mb-3 ">
									    <label for="setting-input-2" class="form-label">email</label>
									    <?php 
											echo '<input name="email" type="email" class="form-control signin-email" placeholder="Email address"  value="'.$email.'" readonly>'
										?>
									</div>
									<div class="mb-3 ">
									    <label for="setting-input-2" class="form-label">เบอร์โทรศัพท์</label>
									    <?php 
											echo '<input name="telnum" type="text" class="form-control" id="setting-input-1" value="'.$telnum.'" readonly>'
										?>
									</div>
									<div class="mb-3 ">
									    <label for="setting-input-2" class="form-label">สถานะ</label>
									    <?php 
											echo '<input name="userrole" type="text" class="form-control" id="setting-input-1" value="'.$userrole.'" readonly>'
										?>
									</div>
								    <!-- <div class="mb-3">
