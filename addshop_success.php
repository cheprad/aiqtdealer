...
<body class="app">   	
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" id="setting-input-1" value="Lorem Ipsum Ltd." disabled>
									</div>
									<div class="mb-3">
									    <label for="setting-input-2" class="form-label">Contact Name</label>
									    <input type="text" class="form-control" id="setting-input-2" value="Steve Doe" disabled>
									</div>
								    <div class="mb-3">
