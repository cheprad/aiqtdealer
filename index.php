					    ...
					    <div class="app-card-body p-3 p-lg-4">
						    ...
						    <div class="row gx-5 gy-3">
						        <div class="col-12 col-lg-9">
							        ...
							        <div>code ประจำวัน</div>
                                    <input id="empty-setup-clone-url" type="text" readonly="" spellcheck="false" class="form-control input-sm input-monospace" data-target="git-clone-help.helpField" value="DEALERCODE" aria-label="Clone URL">
							    </div>
